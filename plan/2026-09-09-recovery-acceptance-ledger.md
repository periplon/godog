...
- Acceptance retry learned that mutation `When` steps must compile the new incremental projection before assertions; retaining the initial plan falsely reported every original scenario.
